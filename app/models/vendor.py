...
class VendorApplication(Base):
    ...
    store_instagram_url: Mapped[str | None] = mapped_column(String(255), nullable=True)
    store_facebook_url: Mapped[str | None] = mapped_column(String(255), nullable=True)
    store_tiktok_url: Mapped[str | None] = mapped_column(String(255), nullable=True)
    store_twitter_url: Mapped[str | None] = mapped_column(String(255), nullable=True)
    store_whatsapp_url: Mapped[str | None] = mapped_column(String(255), nullable=True)
    store_website_url: Mapped[str | None] = mapped_column(String(255), nullable=True)
